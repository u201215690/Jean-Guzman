...
class EventsManager {
    ...
    obtenerDataInicial() {
        ...
        $.ajax({
          ...
          error: function(){
            alert("01 error en la comunicación con el servidor");
          }
        })
    ...
    anadirEvento(){
     ...
     //$('.calendario').fullCalendar('refetchEvents');
      ...
      form_data.append('id_usuario', $('#id_usuario').val())
      ...
      $.ajax({
        url: '../server/new_event.php?new-event=1',
        dataType: "json",
        cache: false,
        processData: false,
        contentType: false,
        ...
        success: (data) =>{
          if (data.msg=="OK") {
            ...
            //$('.calendario').fullCalendar('getView').dayGrid.renderGrid();
            //$('.calendario').addEventSource( data );
            //$('.calendario').render();
            //$('.calendario').fullCalendar('month');
            //$('.calendario').fullCalendar('render'); 
            //$('.calendario').fullCalendar('refetchEvents');
    ...
    eliminarEvento(event, jsEvent){
      ...
      $.ajax({
        url: '../server/delete_event.php?delete-event=1',
        dataType: "json",
        cache: false,
        processData: false,
        contentType: false,
        ...
        error: function(){
          alert("02 error en la comunicación con el servidor");
        }
      })
    ...
    actualizarEvento(evento) {
        ...
        $.ajax({
          url: '../server/update_event.php?update-event=1',
          dataType: "json",
          cache: false,
          processData: false,
          contentType: false,
          ...
          error: function(){
            alert("03 error en la comunicación con el servidor");
          }
        })
    }
