<?php 
session_start();
//echo "acceso ".$_SESSION['auth_usuario'];

if (!isset($_SESSION['auth_usuario'])) {
    header('Location:index.html');
} else {
    $userData = explode("-", $_SESSION['auth_usuario']);
    $idUsu = $userData[0]; //codigo de usuario
    $nombre = $userData[2]; //codigo de usuario
    $apellido = $userData[3]; //codigo de usuario por empresa
}
  ...
  <body>
    ...
    <div class="top-bar">
      <div class="top-bar-left">
        <h3>Agenda <?php echo $nombre.' '.$apellido ;?></h3>
      </div>
    ...
    <div class="expanded-row main-container">
      ...
      <div class="right-cont">
        <div class="add-btn">
          <h5>Nuevo Evento</h5>
          <form>
            <input id="id_usuario" name ="id_usuario" type="hidden" value ="<?php echo $idUsu;?>" >
            <div class="row">
    ...
    <script src="//cdnjs.cloudflare.com/ajax/libs/fullcalendar/1.3.5/lang-all.js"></script>
